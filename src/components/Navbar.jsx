        ...
        <nav className="top-0 left-0 right-0 backdrop-blur-lg bg-white/70 border-b border-gray-100 shadow-sm">
            <div className="flex justify-between items-center p-6 max-w-7xl mx-auto">
                <div className="flex items-center gap-8">
                    ...
                    <ul className="flex gap-8 text-sm font-medium bg-white/50 backdrop-blur-sm 
                                 px-8 py-3 rounded-full shadow-sm">
                        <li>
                ...
                <div className="flex gap-4">
                    <a href="#" target="_blank" 
                       className="text-sm font-medium bg-black text-white rounded-xl px-6 py-3 
                                hover:bg-gray-800 transition-all hover:scale-105 shadow-sm">
                        Repositorio
                    </a>
                    <a href="https://astro-compipro-page.pages.dev/" target="_blank" 
                       className="text-sm font-medium bg-amber-300 rounded-xl px-6 py-3 
                                hover:bg-amber-400 transition-all hover:scale-105 shadow-sm">
                        Visitar Web
                    </a>
                </div>
            </div>
